...
; Function to make the lines that go trough the middle of the road
to draw-road-lines
  ...
  while [ y <= first lanes + 1 ] [
    if not member? y lanes [
      ...
      ifelse abs y = number-of-lanes
        ...
        [ draw-line y black 0.5 ] ; dashed white between lanes
    ]
...
"" ""
PENS
"red car" 1.0 0 -2674135 true "" "plot [speed] of selected-car"
